...
import com.example.ottylab.bitzenyminer.utilities.Notification;
    ...
    public void restartForeground() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            try {
                ...
                startForeground(NOTIFICATION_ID, notification.setNotification(this, "Bitnet Android Miner is running", "Android Miner is now mining for BIT", R.drawable.ic_sleep));
